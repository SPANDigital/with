...
func TestNoop(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Noop(); !reflect.DeepEqual(got, tt.want) {
...
func TestOnCondition(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := OnCondition(tt.args.condition, tt.args.withOptions...); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("OnCondition() = %v, want %v", got, tt.want)
			}
		})
	}
}
